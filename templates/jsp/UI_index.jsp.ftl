...
<!-- BEGIN THEME STYLES -->
<link href="<%=path%>/js/assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.css"  rel="stylesheet" type="text/css"/>
<link href="<%=path%>/js/assets/plugins/gritter/css/jquery.gritter.css"  rel="stylesheet" type="text/css"/>
...
<link href="<%=path%>/js/assets/plugins/fullcalendar/fullcalendar/fullcalendar.css"  rel="stylesheet" type="text/css"/>
<link href="<%=path%>/js/assets/css/themes/default.css"  rel="stylesheet" type="text/css" id="style_color"/>
<link href="<%=path%>/js/assets/css/pages/tasks.css"  rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
					...
					<div class="portlet solid bordered light-grey">
						...
						<div class="portlet-body">
							<div id="site_statistics_loading">
								<img src="<%=path%>/js/assets/img/loading.gif" alt="loading"/>
							</div>
										...
										<div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
											<div class="row">
												<div class="col-md-6 user-info">
													<img alt="" src="<%=path%>/js/assets/img/avatar.png"  class="img-responsive"/>
													<div class="details">
														<div>
															<a href="#">
																 Robert Nilson
					...
					<div class="portlet">
						...
						<div class="portlet-body" id="chats">
							<div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
								<ul class="chats">
									<li class="in">
										<img class="avatar img-responsive" alt="" src="<%=path%>/js/assets/img/avatar1.jpg" />
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="<%=path%>/js/assets/img/avatar2.jpg" />
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
									...
									<li class="out">
										<img class="avatar img-responsive" alt="" src="<%=path%>/js/assets/img/avatar3.jpg" />
										<div class="message">
											<span class="arrow">
											</span>
											<a href="#" class="name">
...
<script src="<%=path%>/js/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js"  type="text/javascript"></script>
...
<script src="<%=path%>/js/assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js"  type="text/javascript"></script>
...
<script src="<%=path%>/js/assets/plugins/flot/jquery.flot.min.js"  type="text/javascript"></script>
<script src="<%=path%>/js/assets/plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
<script src="<%=path%>/js/assets/plugins/flot/jquery.flot.categories.min.js"  type="text/javascript"></script>
<script src="<%=path%>/js/assets/plugins/bootstrap-daterangepicker/moment.min.js"  type="text/javascript"></script>
<script src="<%=path%>/js/assets/plugins/bootstrap-daterangepicker/daterangepicker.js"  type="text/javascript"></script>
<script src="<%=path%>/js/assets/plugins/gritter/js/jquery.gritter.js"  type="text/javascript"></script>
<script src="<%=path%>/js/assets/plugins/fullcalendar/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
<script src="<%=path%>/js/assets/scripts/core/app.js" ></script> 
<script src="<%=path%>/js/assets/plugins/jquery.sparkline.min.js"  type="text/javascript"></script>
<script src="<%=path%>/js/assets/scripts/custom/index.js"  type="text/javascript"></script>
<script src="<%=path%>/js/assets/scripts/custom/tasks.js" type="text/javascript"></script>
