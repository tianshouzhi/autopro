...
<sqlMap namespace="${basePackage}.domain.${dbTable.entityName?cap_first}" >
  <resultMap id="${dbTable.entityName?cap_first}" class="${basePackage}.domain.${dbTable.entityName?cap_first}" >
	...
	<!--主键-->
	<id column="${PKColumn.columnName}"	property="${PKColumn.propertyName}" jdbcType="${PKColumn.jdbcType}"/>
	</#list>
	
	<#list dbTable.tableColumns as tableColumn>
	<result  property="${tableColumn.propertyName}" column="${tableColumn.columnName}" jdbcType="${tableColumn.jdbcType}"/>
	</#list>
